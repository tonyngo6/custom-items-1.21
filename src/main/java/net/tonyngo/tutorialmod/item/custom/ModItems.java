package net.tonyngo.tutorialmod.item;
...
import net.tonyngo.tutorialmod.item.custom.MetalDetectorItem;
import net.tonyngo.tutorialmod.item.custom.ModArmorItem;
